...
def worker(cmd, input, **kwargs):
    ...
    return subprocess.CompletedProcess(cmd, 0, json.dumps({**fixture.window_manifest(request['texts']), 'model': 'fixture/model', 'revision': 'rev', 'dimension': 2,
...
class RefreshTests(unittest.TestCase):
    ...
    def test_schema_one_upgrade_preserves_rows_and_vectors(self):
        ...
        try:
            ...
            self.assertEqual(migrated.status()['semantic_vectors'], 0)  # Legacy vectors require token-window rebuild.
